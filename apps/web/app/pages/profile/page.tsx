...
export default function ProfilePage() {
  ...
  async function logWeight(event: FormEvent<HTMLFormElement>) {
    ...
    if (bodyFat !== null && (!Number.isFinite(bodyFat) || bodyFat < 0 || bodyFat > 100)) return;
  ...
  async function updateHeight(event: FormEvent<HTMLFormElement>) {
    ...
    setProfile((current) => ({ ...current, height_cm: savedHeight || height }));
